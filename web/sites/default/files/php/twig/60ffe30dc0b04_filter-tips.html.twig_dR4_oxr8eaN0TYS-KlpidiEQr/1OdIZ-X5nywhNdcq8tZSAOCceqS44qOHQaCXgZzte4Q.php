...
class __TwigTemplate_4578c919805e7187c466d26e49178defb4ea081611f688559e57ece92d2bfc06 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig", "/var/www/web/themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig");
    }
